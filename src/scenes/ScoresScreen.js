...
export default class ScoresScreen extends Phaser.Scene {
    ...
    preload() {
        this.load.image('highscores_bg', '/assets/startBg.png')
        this.load.image('back_btn', '/assets/back.png')
        this.load.image('highscores_header', '/assets/highscoresHeader.png')
    }

    create() {
        this.add.image(400, 300, 'highscores_bg')
        let backBtn = this.add.image(150, 155, 'back_btn')
